...
public class WSDLdocMojo
    ...
    /**
     * WSDLdoc href prefix to be used in documentation
     * (see path prefix)
     *
     * @parameter expression = "${wsdldoc.hpref-prefix}" default-value="null"
     */
    private String hrefPrefix;
    
    /**
     * WSDLdoc path prefix to be used in documentation
     * (see href prefix)
     *
     * @parameter expression = "${wsdldoc.path-prefix}" default-value="null"
     */
	...
	if (hrefPrefix.equalsIgnoreCase("null")) {
	    hrefPrefix = null;
	}
	if (pathPrefix.equalsIgnoreCase("null")) {
	    pathPrefix = null;
	}
