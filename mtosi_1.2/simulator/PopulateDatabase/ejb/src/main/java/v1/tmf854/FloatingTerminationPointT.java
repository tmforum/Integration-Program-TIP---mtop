...
public class FloatingTerminationPointT implements Serializable {
    ...
    @XmlTransient
    @OneToOne(cascade={CascadeType.ALL})
    @JoinColumn(name="ftpInv")
    private FTPInventoryT ftpInventoryT;
    ...
    public FTPInventoryT getFtpInventoryT() {
        return ftpInventoryT;
    }
    
    public void setFtpInventoryT(FTPInventoryT ftpInventoryT) {
        this.ftpInventoryT = ftpInventoryT;
    }
