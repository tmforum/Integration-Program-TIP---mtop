 ...
 *       
 * 
 * <p>Java class for ConnectionTerminationPointList_T complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ConnectionTerminationPointList_T">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="CTP" type="{tmf854.v1}ConnectionTerminationPoint_T" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "ConnectionTerminationPointList_T", propOrder = {
    "ctp"
})
public class ConnectionTerminationPointListT {

    @XmlElement(name = "CTP")
    protected List<ConnectionTerminationPointT> ctp;
    @XmlAttribute
     ...
     * 
     */
    public List<ConnectionTerminationPointT> getCTP() {
        if (ctp == null) {
            ctp = new ArrayList<ConnectionTerminationPointT>();
        }
        return this.ctp;
    }
