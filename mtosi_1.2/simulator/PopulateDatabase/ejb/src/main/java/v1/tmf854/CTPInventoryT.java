 ...
 *
 *
 * <p>Java class for CTP_Inventory_T complex type.
 *
 * <p>The following schema fragment specifies the expected content contained within this class.
 *
 * <pre>
 * &lt;complexType name="CTP_Inventory_T">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;all>
 *         &lt;element name="ctpNm" type="{tmf854.v1}NameValue_T" minOccurs="0"/>
 *         &lt;element name="ctpAttrs" type="{tmf854.v1}ConnectionTerminationPoint_T" minOccurs="0"/>
...
@XmlType(name = "CTP_Inventory_T", propOrder = {
    
})
@Entity
@Table(name = "CTPINV")
public class CTPInventoryT implements Serializable {
    @XmlTransient
    @Id
    @GeneratedValue(strategy = GenerationType.AUTO)
    @Column(name="CTPINV_ID")
    private Long id;
    protected String ctpNm;
   @Transient
    protected ConnectionTerminationPointT ctpAttrs;
    @Transient
    ...
    /**
     * Gets the value of the ctpAttrs property.
     *
     * @return
     *     possible object is
     ...
     *
     */
    public ConnectionTerminationPointT getCtpAttrs() {
        return ctpAttrs;
    }
    
    /**
     * Sets the value of the ctpAttrs property.
     *
     * @param value
     *     allowed object is
     *     {@link ConnectionTerminationPointT }
     *
     */
    public void setCtpAttrs(ConnectionTerminationPointT value) {
        this.ctpAttrs = value;
    }
