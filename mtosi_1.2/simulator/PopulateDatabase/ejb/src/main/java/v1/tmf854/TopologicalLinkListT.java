 ...
 *       
 * 
 * <p>Java class for TopologicalLinkList_T complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="TopologicalLinkList_T">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="tl" type="{tmf854.v1}TopologicalLink_T" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "TopologicalLinkList_T", propOrder = {
    "tl"
})
public class TopologicalLinkListT {

    protected List<TopologicalLinkT> tl;
    @XmlAttribute
     ...
     * 
     */
    public List<TopologicalLinkT> getTl() {
        if (tl == null) {
            tl = new ArrayList<TopologicalLinkT>();
        }
        return this.tl;
    }
