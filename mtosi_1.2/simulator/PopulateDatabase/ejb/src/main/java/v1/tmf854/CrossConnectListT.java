 ...
 *       
 * 
 * <p>Java class for CrossConnectList_T complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="CrossConnectList_T">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="cc" type="{tmf854.v1}CrossConnect_T" maxOccurs="unbounded"/>
 *       &lt;/sequence>
...
@XmlType(name = "CrossConnectList_T", propOrder = {
    "cc"
})
public class CrossConnectListT {

    @XmlElement(required = true)
    protected List<CrossConnectT> cc;
    @XmlAttribute
     ...
     * 
     */
    public List<CrossConnectT> getCc() {
        if (cc == null) {
            cc = new ArrayList<CrossConnectT>();
        }
        return this.cc;
    }
