...
/**
 * <p>Java class for ConnectionTerminationPoint_T complex type.
 *
 * <p>The following schema fragment specifies the expected content contained within this class.
 *
 * <pre>
 * &lt;complexType name="ConnectionTerminationPoint_T">
 *   &lt;complexContent>
 ...
 *         &lt;element name="vendorExtensions" type="{tmf854.v1}CTPVendorExtensions_T" minOccurs="0"/>
 *       &lt;/all>
...
@XmlType(name = "ConnectionTerminationPoint_T", propOrder = {
})
@Entity
@Table(name = "CTP")
public class ConnectionTerminationPointT  implements Serializable {
    @Id
    @XmlTransient
    ...
    @XmlTransient
    @OneToOne(cascade={CascadeType.ALL})
    @JoinColumn(name="ctpInv")
    private CTPInventoryT ctpInventoryT;
   ...
   @OneToOne(cascade={CascadeType.ALL})
    @JoinColumn(name="I_TDNM_FK", referencedColumnName="NAMEATT_ID")
    ...
    @OneToOne(cascade={CascadeType.ALL})
   @JoinColumn(name="LPL_FK", referencedColumnName="ID")
    protected LayeredParametersListT transmissionParams;
    @Transient
    protected CTPVendorExtensionsT vendorExtensions;
...
//    }
     ...
     * @return
     *     possible object is
     *     {@link CTPVendorExtensionsT }
     *
     */
    public CTPVendorExtensionsT getVendorExtensions() {
     ...
     *
     */
    public void setVendorExtensions(CTPVendorExtensionsT value) {
    ...
    public CTPInventoryT getCtpInventoryT() {
        return ctpInventoryT;
    }

    public void setCtpInventoryT(CTPInventoryT ctpInventoryT) {
        this.ctpInventoryT = ctpInventoryT;
    }
