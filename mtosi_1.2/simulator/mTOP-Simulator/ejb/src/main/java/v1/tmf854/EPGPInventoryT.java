 ...
 *       
 * 
 * <p>Java class for EPGP_Inventory_T complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="EPGP_Inventory_T">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;all>
 *         &lt;element name="epgpNm" type="{tmf854.v1}NameValue_T" minOccurs="0"/>
 *         &lt;element name="epgpAttrs" type="{tmf854.v1}EProtectionGroup_T" minOccurs="0"/>
...
@XmlType(name = "EPGP_Inventory_T", propOrder = {

})
@Entity
@Table(name = "EPGPINV")
public class EPGPInventoryT  implements Serializable {
    @XmlTransient
    @Id
    @GeneratedValue(strategy = GenerationType.AUTO)
    @Column(name="EPGPINV_ID")
    private Long id;
    protected String epgpNm;
     @Transient
    protected EProtectionGroupT epgpAttrs;
     @Transient
    ...
    /**
     * Gets the value of the epgpAttrs property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public EProtectionGroupT getEpgpAttrs() {
        return epgpAttrs;
    }

    /**
     * Sets the value of the epgpAttrs property.
     * 
     * @param value
     *     allowed object is
     *     {@link EProtectionGroupT }
     *     
     */
    public void setEpgpAttrs(EProtectionGroupT value) {
        this.epgpAttrs = value;
    }
