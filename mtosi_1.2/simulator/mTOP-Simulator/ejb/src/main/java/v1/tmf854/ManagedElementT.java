...
public class ManagedElementT implements Serializable {
    ...
    public void setMeInventoryT(MEInventoryT meInventoryT) {
      ...
      public Object copyManagedElementT() {
        ManagedElementT me = new ManagedElementT();
        me.setDiscoveredName(discoveredName);
        me.setMeInventoryT(meInventoryT);
        me.setAliasNameList(aliasNameList);
        me.setName(name);
