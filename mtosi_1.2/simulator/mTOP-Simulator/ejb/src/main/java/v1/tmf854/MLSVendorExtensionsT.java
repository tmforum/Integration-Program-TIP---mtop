...
/**
 * Extension for MTOSI MultiLayerSubnetwork
 * 
 * <p>Java class for MLSVendorExtensions_T complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="MLSVendorExtensions_T">
 *   &lt;complexContent>
...
@XmlType(name = "MLSVendorExtensions_T", propOrder = {
    "any"
})
//@Entity
//@Table(name = "MLSVENDOREXTENSIONS")
public class MLSVendorExtensionsT implements Serializable {
   @XmlTransient
//    @Id
//    @GeneratedValue(strategy = GenerationType.AUTO)
    private Long id;
    @XmlAnyElement(lax = true)
    protected ArrayList<String> any;
    @XmlAttribute
