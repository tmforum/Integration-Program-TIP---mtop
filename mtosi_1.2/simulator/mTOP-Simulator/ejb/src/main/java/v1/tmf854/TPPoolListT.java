 ...
 *       
 * 
 * <p>Java class for TPPoolList_T complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="TPPoolList_T">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="tpPool" type="{tmf854.v1}TPPool_T" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "TPPoolList_T", propOrder = {
    "tpPool"
})
public class TPPoolListT {

    protected List<TPPoolT> tpPool;
    @XmlAttribute
     ...
     * 
     */
    public List<TPPoolT> getTpPool() {
        if (tpPool == null) {
            tpPool = new ArrayList<TPPoolT>();
        }
        return this.tpPool;
    }
