...
public class NamingAttributesT implements Serializable{
    ...
    public void initBIs(Map baseInstancesMap, List<NamingAttributesT> baseInstance) {
        System.out.println("**********NamingAttrubutes: init**********");
        System.out.println(" baseInstancesMap.size(): " +  baseInstancesMap.size() );
        
        int nbNatts = baseInstancesMap.size() / 8;
        System.out.println("nbNatts: " + nbNatts);
        ...
        for (int i = 0; i < nbNatts ; i++) {
            ...
            System.out.println("value10:: " + baseInstancesMap.get("baseInstanceValue10"));
            System.out.println("type10:: " + baseInstancesMap.get("baseInstanceType10"));
            
            if (!notSpecified(baseInstancesMap.get("baseInstanceType1"+i))) {
                // at least 1 ObjectType type specified
                System.out.println(" namingAttrs1.setMdNm");
                ...
                System.out.println("baseInstance.add(namingAttrs1);");
                baseInstance.add(namingAttrs1);
            } else {
                System.out.println("You must Specify MD Typee :");
            }
    ...
    public void initIOTs(Map includedObjectTypesMap, 
         ...
         System.out.println("nbIots: " + nbIots);
