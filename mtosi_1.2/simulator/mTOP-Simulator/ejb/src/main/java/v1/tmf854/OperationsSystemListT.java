 ...
 *       
 * 
 * <p>Java class for OperationsSystemList_T complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="OperationsSystemList_T">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="os" type="{tmf854.v1}OperationsSystem_T" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "OperationsSystemList_T", propOrder = {
    "os"
})
public class OperationsSystemListT {

    protected List<OperationsSystemT> os;
    @XmlAttribute
     ...
     * 
     */
    public List<OperationsSystemT> getOs() {
        if (os == null) {
            os = new ArrayList<OperationsSystemT>();
        }
        return this.os;
    }
