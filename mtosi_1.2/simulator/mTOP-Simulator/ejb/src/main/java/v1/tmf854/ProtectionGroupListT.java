 ...
 *       
 * 
 * <p>Java class for ProtectionGroupList_T complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ProtectionGroupList_T">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="pgp" type="{tmf854.v1}ProtectionGroup_T" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "ProtectionGroupList_T", propOrder = {
    "pgp"
})
public class ProtectionGroupListT {

    protected List<ProtectionGroupT> pgp;
    @XmlAttribute
     ...
     * 
     */
    public List<ProtectionGroupT> getPgp() {
        if (pgp == null) {
            pgp = new ArrayList<ProtectionGroupT>();
        }
        return this.pgp;
    }
