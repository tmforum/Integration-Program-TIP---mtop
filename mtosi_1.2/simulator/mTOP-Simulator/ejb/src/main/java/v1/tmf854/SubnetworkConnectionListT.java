 ...
 *       
 * 
 * <p>Java class for SubnetworkConnectionList_T complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="SubnetworkConnectionList_T">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="snc" type="{tmf854.v1}SubnetworkConnection_T" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "SubnetworkConnectionList_T", propOrder = {
    "snc"
})
public class SubnetworkConnectionListT {

    protected List<SubnetworkConnectionT> snc;
    @XmlAttribute
     ...
     * 
     */
    public List<SubnetworkConnectionT> getSnc() {
        if (snc == null) {
            snc = new ArrayList<SubnetworkConnectionT>();
        }
        return this.snc;
    }
