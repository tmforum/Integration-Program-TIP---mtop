...
function invoke(btn)
{
    if(btn == 0) document.myform.action="iterator.do";
    if(btn == 1) document.myform.action="refresh.do";
    ...
    <body>
        ...
        <h1 style="color: mediumslateblue; text-align:center">
           ...
           <form method="post" name="myform" action="">
                ...
                <input type="button" value="Send a GetInventoryIterator request" onclick="invoke(0)"> 
                <input type="button" value="Refresh" onclick="invoke(1)"> 
            </form>
            <hr>
