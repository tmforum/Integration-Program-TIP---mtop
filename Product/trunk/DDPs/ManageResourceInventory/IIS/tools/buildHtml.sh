...
## Generate doc
##
java -DWSDL_HOME=$WSDL_HOME -Xmx256m -jar $WSDL_HOME/wsdldoc.jar -title "MTOSI R2.0 ManageResourceInventory DDP IIS" -verbose -dir $HTML_HOME ../xsd/* ../wsdl/*/*Jms.wsdl ../wsdl/*/*Http.wsdl
...
perl -pi -e 's/href="file:\/.:\/TMF_GFORGE\/mTOP\/Product\/trunk\/DDPs\/ManageResourceInventory\/IIS\//href="\.\.\//g' $HTML_HOME/overview.html

perl -pi -e 's/>file:\/.:\/TMF_GFORGE\/mTOP\/Product\/trunk\/DDPs\/ManageResourceInventory\/IIS\//>file:\//g' $HTML_HOME/overview.html
...
find $HTML_HOME/ -name "*.html" | xargs perl -pi -e 's/href="file:\/.:\/TMF_GFORGE\/mTOP\/Product\/trunk\/DDPs\/ManageResourceInventory\/IIS\//href="\.\.\/\.\.\/\.\.\/\.\.\//g'

find $HTML_HOME/ -name "*.html" | xargs perl -pi -e 's/>file:\/.:\/TMF_GFORGE\/mTOP\/Product\/trunk\/DDPs\/ManageResourceInventory\/IIS\//>file:\//g'
...
cd ..
jar -cvf ./ManageResourceInventoryHtml.zip ./html
cd tools
