...
java -Xmx256m -classpath "%cp%" org.apache.xmlbeans.impl.tool.SchemaCompiler -mx 800m  -d %CLASS_HOME% -src %SRC_HOME% -out %DDP_HOME%\derived\New_Framework.jar -javasource 1.5 -debug ..\xsd

REM Package into library
cd %SRC_HOME%
jar -cvf ..\..\derived\New_FrameworkJava.zip .
cd ..\..\tools
