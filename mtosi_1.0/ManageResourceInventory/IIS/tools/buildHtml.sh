...
perl -pi -e 's/href="file:\/.:\/GForge_mTOP\/Product\/trunk\/DDPs\/ManageResourceInventory\/IIS\//href="\.\.\//g' $HTML_HOME/overview.html

perl -pi -e 's/>file:\/.:\/GForge_mTOP\/Product\/trunk\/DDPs\/ManageResourceInventory\/IIS\//>file:\//g' $HTML_HOME/overview.html

find $HTML_HOME/ -name "*.html" | xargs perl -pi -e 's/href="file:\/.:\/GForge_mTOP\/Product\/trunk\/DDPs\/ManageResourceInventory\/IIS\//href="\.\.\/\.\.\/\.\.\/\.\.\//g'

find $HTML_HOME/ -name "*.html" | xargs perl -pi -e 's/>file:\/.:\/GForge_mTOP\/Product\/trunk\/DDPs\/ManageResourceInventory\/IIS\//>file:\//g'
